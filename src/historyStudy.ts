...
const kurulusEvents: HistoryTimelineEvent[] = [
  ...
  },
  {
    ...
    mnemonic: {
      title: "Orhan Bey Teşkilatlanma Şifresi",
      code: "D - İ - V - A - N - Y",
      description: "Devletleşmenin temelleri Orhan Gazi döneminde atıldı:",
      items: [
        { letter: "D", name: "Divan-ı Hümayun", detail: "İlk devlet divanı kuruldu." },
        { letter: "İ", name: "İznik Medresesi", detail: "İlk medrese açıldı (Dâvûd-ı Kayserî ilk müderris)." },
        { letter: "V", name: "Vezirlik", detail: "İlk vezir atandı (Alaeddin Paşa)." },
        { letter: "A", name: "Akçe", detail: "İlk gümüş para basıldı." },
        { letter: "N", name: "Naval / Donanma", detail: "Karesioğulları alınarak ilk donanma ve Karamürsel tersanesi kuruldu." },
        { letter: "Y", name: "Yaya ve Müsellem", detail: "İlk düzenli Türk ordusu kuruldu." },
      ],
    },
    examNote:
    ...
    keywords: ["Bursa", "Pelekanon", "Karesioğulları", "Çimpe Kalesi", "Divan", "Yaya ve Müsellem", "İznik Orhaniyesi", "DİVANY"],
  },
  {
  ...
  },
  {
    ...
    mnemonic: {
      ...
      items: [
        { letter: "AY", name: "Aydınoğulları", detail: "Batı Anadolu denizci beyliği." },
        { letter: "SA", name: "Saruhanoğulları", detail: "Manisa çevresi." },
        { letter: "ME", name: "Menteşeoğulları", detail: "Muğla çevresi denizci beylik." },
        { letter: "GE", name: "Germiyanoğulları", detail: "Kütahya ve çevresi." },
        { letter: "KA", name: "Karamanoğulları", detail: "Konya ve Karaman bölgesi." },
      ],
    },
    examNote:
    ...
    keywords: ["Niğbolu", "Sultan-ı İklim-i Rum", "Anadolu Hisarı", "Ankara Savaşı", "Bursa Ulu Camii", "AYSAMEGEKA"],
  },
  {
    ...
    mnemonic: {
      ...
      items: [
        ...
        { letter: "M", name: "Musa Çelebi", detail: "Edirne ve Rumeli kolu (İstanbul'u kuşattı)." },
        { letter: "S", name: "Süleyman Çelebi", detail: "Edirne kolu." },
        { letter: "M", name: "Mehmed Çelebi", detail: "Amasya kolu (Birliği sağlayan 2. Kurucu)." },
      ],
    },
    examNote:
...
const yukselmeEvents: HistoryTimelineEvent[] = [
  ...
  },
  {
    ...
    mnemonic: {
      title: "Kanuni Dönemi İç İsyanları Şifresi",
      code: "C - A - B - A (CABA)",
      ...
      items: [
        ...
        { letter: "A", name: "Kalender Çelebi İsyanı", detail: "Maraş/Anadolu'da dini-sosyal nitelikli isyan." },
      ],
    },
    examNote:
    ...
    keywords: ["Mohaç", "1533 İstanbul Antlaşması", "Preveze", "Akdeniz Türk Gölü", "1555 Amasya", "Kapitülasyon", "CABA", "Zigetvar"],
  },
  {
...
const dagilmaEvents: HistoryTimelineEvent[] = [
  ...
  },
  {
    ...
    mnemonic: {
      title: "1878 Berlin Antlaşması'nda Bağımsız Olanlar",
      code: "S - A - K - A - R (SAKAR)",
  ...
  },
  {
    ...
    mnemonic: {
      title: "Kuzey Afrika'da Toprak Kayıp Sırası",
      code: "C - T - T - M (Ce-Ti-Te-Me)",
      description: "Osmanlı'nın Kuzey Afrika'daki topraklarını kaybetme sırası:",
      items: [
        ...
        { letter: "T", name: "Trablusgarp (1912)", detail: "İtalya'ya bırakıldı (Uşi Antlaşması - Son kayıp)." },
      ],
    },
    examNote:
    ...
    keywords: ["Trablusgarp", "Derne-Tobruk", "Uşi Antlaşması", "Balkan Savaşları", "Arnavutluk", "Bâbıâli Baskını", "Edirne Fatihi", "CTTM", "Romanya"],
  },
  {
...
const kulturSections: CultureTopicSection[] = [
  ...
  },
  {
    ...
    mnemonic: {
      title: "Yönetici Sınıfların Baş Temsilcileri",
      code: "S - İ - K (SEYFİYE - İLMİYE - KALEMİYE)",
      description: "Devlet idaresindeki üç büyük bürokrasi sınıfı:",
      items: [
        { letter: "SEYFİYE", name: "Kılıç / Askeri", detail: "Sadrazam, Vezirler, Kaptan-ı Derya, Yeniçeri Ağası." },
        { letter: "İLMİYE", name: "Din / Hukuk / İlim", detail: "Şeyhülislam (Fetva), Kazasker (Kadı-Müderris atayan), Kadılar." },
        { letter: "KALEMİYE", name: "Kalem / Yazı / Maliye", detail: "Defterdar (Maliye), Nişancı (Tuğra & Tapu), Reisülküttap (Dışişleri)." },
      ],
    },
    examNote:
  ...
  },
  {
    ...
    mnemonic: {
      title: "Mimar Sinan'ın 3 Büyük Şaheseri",
      code: "Ç - K - U (Şehzade - Süleymaniye - Selimiye)",
      description: "Mimar Sinan'ın kariyer basamakları:",
      items: [
        { letter: "Ç", name: "Çıraklık Eseri", detail: "Şehzadebaşı Camii (İstanbul)." },
        { letter: "K", name: "Kalfalık Eseri", detail: "Süleymaniye Camii (İstanbul)." },
        { letter: "U", name: "Ustalık Eseri", detail: "Selimiye Camii (Edirne - UNESCO Dünya Mirası)." },
      ],
    },
    examNote:
...
export const ALL_MASTER_MNEMONICS: (Mnemonic & { periodName: string; periodId: string })[] = [
  ...
  },
  {
    periodName: "1. Kuruluş Dönemi",
    periodId: "kurulus",
    title: "Yıldırım'ın Son Verdiği Beylikler",
    code: "AY - SA - ME - GE - KA",
  ...
  },
  {
    periodName: "1. Kuruluş Dönemi",
    periodId: "kurulus",
    title: "Fetret Devri Şehzadeleri",
    code: "İ - M - S - M",
    description: "11 yıllık taht kavgasına katılan Yıldırım'ın oğulları:",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { letter: "A", name: "Kalender Çelebi", detail: "Maraş çevresi dini/sosyal Türkmen isyanı." },
    ],
  },
  {
    periodName: "2. Yükselme Dönemi",
    periodId: "yukselme",
    title: "Yavuz'un Doğu Seferleri Sırası",
    code: "Ç - T - M - R (ÇATAMAR)",
  ...
  },
  {
    periodName: "2. Yükselme Dönemi",
    periodId: "yukselme",
    title: "Mimar Sinan'ın Başyapıtları",
    code: "Ç - K - U (Şehzade - Süleymaniye - Selimiye)",
    description: "Mimar Sinan'ın kendi tanımlamasıyla mimari evreleri:",
    items: [
      { letter: "Ç", name: "Çıraklık", detail: "Şehzadebaşı Camii (İstanbul)." },
      { letter: "K", name: "Kalfalık", detail: "Süleymaniye Camii (İstanbul)." },
      { letter: "U", name: "Ustalık", detail: "Selimiye Camii (Edirne - UNESCO)." },
    ],
  },
  ...
  // Dağılma
  {
    ...
    items: [
      { letter: "İ", name: "1812 Bükreş", detail: "İlk kez İMTİYAZ (Ayrıcalık) elde ettiler." },
      { letter: "M", name: "1829 Edirne", detail: "MUHTARİYET (Özerklik) kazandılar." },
      { letter: "B", name: "1878 Berlin", detail: "Tam BAĞIMSIZ oldular." },
    ],
  },
  {
    periodName: "5. Dağılma Dönemi",
  ...
  },
  {
    periodName: "5. Dağılma Dönemi",
    periodId: "dagilma",
    title: "1908 Meşrutiyet Kayıpları",
    code: "B - B - G (BBG)",
  ...
  },
  {
    periodName: "5. Dağılma Dönemi",
    periodId: "dagilma",
    title: "Kuzey Afrika'da Kayıp Sırası",
    code: "C - T - T - M (Ce-Ti-Te-Me)",
  ...
  // Kültür ve Medeniyet
  {
    ...
    title: "Divan-ı Hümayun 3 Sınıfı",
    code: "S - İ - K (SEYFİYE - İLMİYE - KALEMİYE)",
    description: "Devlet idaresindeki üç büyük bürokrasi sınıfı:",
    items: [
      { letter: "SEYFİYE", name: "Kılıç / Askeri", detail: "Sadrazam, Vezirler, Kaptan-ı Derya, Yeniçeri Ağası." },
  ...
  },
  {
    periodName: "6. Kültür & Medeniyet",
    periodId: "kultur-uygarlik",
    title: "Mimar Sinan'ın 3 Şaheseri",
    code: "Ç - K - U",
    description: "Mimar Sinan'ın mimari evreleri:",
    items: [
      { letter: "Ç", name: "Çıraklık Eseri", detail: "Şehzadebaşı Camii (İstanbul)." },
      { letter: "K", name: "Kalfalık Eseri", detail: "Süleymaniye Camii (İstanbul)." },
      { letter: "U", name: "Ustalık Eseri", detail: "Selimiye Camii (Edirne - UNESCO)." },
    ],
  },
];
