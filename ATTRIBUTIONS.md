...
Türkiye'nin 81 iline ait SVG yol verileri:

- Proje: `turkey-map-react`
- Kaynak: https://github.com/erdigokce/turkey-map-react
- Lisans: MIT
- Kullanılan npm sürümü: `2.0.5`

Uygulama, paketin hazır React görünümünü değil yalnızca il sınırı verilerini
kullanır. Etkileşim, renklendirme, erişilebilirlik ve kayıt katmanı bu proje
içinde uygulanmıştır.

## Hazır set görselleri

Dağlar hazır setindeki fotoğraflar Wikimedia Commons üzerinden yerel olarak
saklanır:

- Ağrı Dağı — Vyacheslav Argenberg — CC BY 4.0  
  https://commons.wikimedia.org/wiki/File:Mount_Ararat,_Ararat_Plain,_Armenia.jpg
- Erciyes Dağı — Georges Jansoone (JoJan) — CC BY 3.0 / GFDL  
  https://commons.wikimedia.org/wiki/File:Turkey.Mount_Erciyes01.jpg
- Kaçkar Dağı — A. Erdem Şentürk — CC BY-SA 4.0  
  https://commons.wikimedia.org/wiki/File:Ka%C3%A7kar_Da%C4%9F%C4%B1.jpg

Fotoğraflar arayüze uygun boyutta gösterilir; eser sahipliği ve lisansları
değiştirilmemiştir.

## Ders içeriği kaynakları

Hazır setlerdeki sınıflandırma ve hızlı sınav notları, MEB OGM Materyal konu
özetleri esas alınarak düzenlenmiştir:
...
- Türkiye'nin akarsu havzaları:  
  https://ogmmateryal.eba.gov.tr/kitap/mebi-konu-ozetleri/tyt-cografya/files/basic-html/page83.html
...
- Altın: https://www.enerji.gov.tr/bilgimerkezi-tabikaynaklar-altin
- Trona: https://enerji.gov.tr/infobank-naturalresources-trona
